...
/*
 * Wrappers for bdrv_co_nb_sectors
 */

typedef struct BdrvNbSectors {
    BdrvPollCo poll_state;
    int64_t ret;
    BlockDriverState *bs;
} BdrvNbSectors;

static void coroutine_fn bdrv_co_nb_sectors_entry(void *opaque)
{
    BdrvNbSectors *s = opaque;


    s->ret = bdrv_co_nb_sectors(s->bs);
...
int64_t bdrv_nb_sectors(BlockDriverState *bs)
{
    if (qemu_in_coroutine()) {
        ...
        s.poll_state.co = qemu_coroutine_create(bdrv_co_nb_sectors_entry, &s);
...
/*
 * Wrappers for blk_co_nb_sectors
 */

typedef struct BlkNbSectors {
    BdrvPollCo poll_state;
    int64_t ret;
    BlockBackend *blk;
} BlkNbSectors;

static void coroutine_fn blk_co_nb_sectors_entry(void *opaque)
{
    BlkNbSectors *s = opaque;


    s->ret = blk_co_nb_sectors(s->blk);
...
int64_t blk_nb_sectors(BlockBackend *blk)
{
    if (qemu_in_coroutine()) {
        ...
        s.poll_state.co = qemu_coroutine_create(blk_co_nb_sectors_entry, &s);
...
/*
 * Wrappers for blk_co_io_plug
 */

typedef struct BlkIoPlug {
    BdrvPollCo poll_state;
    
    BlockBackend *blk;
} BlkIoPlug;

static void coroutine_fn blk_co_io_plug_entry(void *opaque)
{
    BlkIoPlug *s = opaque;


    blk_co_io_plug(s->blk);
...
void blk_io_plug(BlockBackend *blk)
{
    ...
    s.poll_state.co = qemu_coroutine_create(blk_co_io_plug_entry, &s);
...
/*
 * Wrappers for blk_co_io_unplug
 */

typedef struct BlkIoUnplug {
    BdrvPollCo poll_state;
    
    BlockBackend *blk;
} BlkIoUnplug;

static void coroutine_fn blk_co_io_unplug_entry(void *opaque)
{
    BlkIoUnplug *s = opaque;


    blk_co_io_unplug(s->blk);
...
void blk_io_unplug(BlockBackend *blk)
{
    ...
    s.poll_state.co = qemu_coroutine_create(blk_co_io_unplug_entry, &s);
